...
export default function EditarClienteForm({ cliente, advogados }: { cliente: any, advogados: any[] }) {
  ...
  const [form, setForm] = useState({
    nome_empresa: cliente.nome_empresa || cliente.nome || '',
    ...
    origem: cliente.origem || 'escritorio',
    advogado_origem_id: cliente.advogado_origem_id || '',
  ...
  async function handleSalvar(e: React.FormEvent) {
    ...
    const payload: any = {
      ...
      origem: form.origem,
      advogado_origem_id: form.origem === 'advogado_associado' && form.advogado_origem_id ? form.advogado_origem_id : null,
    ...
    <div className="animate-fade-in" style={{ maxWidth: '680px' }}>
      <div style={{ marginBottom: '1.75rem', display: 'flex', alignItems: 'center', gap: '1rem' }}>
        ...
        <div>
          ...
          <p style={{ color: 'hsl(45 8% 45%)', fontSize: '0.8rem', marginTop: '0.2rem' }}>{cliente.nome_empresa || cliente.nome}</p>
        </div>
      </div>
